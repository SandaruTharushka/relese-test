...
MIGRATIONS: list[Migration] = [
    ...
    Migration(18, 'v6.7 foreign-key indexes for join performance', [
        # Critical join hot paths — every FK that drives lookups in routes/reports.
        "CREATE INDEX IF NOT EXISTS idx_password_resets_user_id ON password_resets(user_id)",
        "CREATE INDEX IF NOT EXISTS idx_supplier_transactions_supplier_id ON supplier_transactions(supplier_id)",
        "CREATE INDEX IF NOT EXISTS idx_supplier_transactions_user_id ON supplier_transactions(user_id)",
        "CREATE INDEX IF NOT EXISTS idx_products_supplier_id ON products(supplier_id)",
        "CREATE INDEX IF NOT EXISTS idx_wholesale_transactions_customer_id ON wholesale_transactions(customer_id)",
        "CREATE INDEX IF NOT EXISTS idx_wholesale_transactions_user_id ON wholesale_transactions(user_id)",
        "CREATE INDEX IF NOT EXISTS idx_held_orders_cashier_id ON held_orders(cashier_id)",
        "CREATE INDEX IF NOT EXISTS idx_sales_wholesale_customer_id ON sales(wholesale_customer_id)",
        "CREATE INDEX IF NOT EXISTS idx_sales_retail_customer_id ON sales(retail_customer_id)",
        "CREATE INDEX IF NOT EXISTS idx_payments_customer_id ON payments(customer_id)",
        "CREATE INDEX IF NOT EXISTS idx_user_logs_user_id_v2 ON user_logs(user_id)",
        ...
        "CREATE INDEX IF NOT EXISTS idx_product_returns_processed_by ON product_returns(processed_by)",
        "CREATE INDEX IF NOT EXISTS idx_return_items_return_id ON return_items(return_id)",
        "CREATE INDEX IF NOT EXISTS idx_return_items_product_id ON return_items(product_id)",
        "CREATE INDEX IF NOT EXISTS idx_imei_records_product_id ON imei_records(product_id)",
        "CREATE INDEX IF NOT EXISTS idx_imei_records_supplier_id ON imei_records(supplier_id)",
        "CREATE INDEX IF NOT EXISTS idx_imei_records_purchase_id ON imei_records(purchase_id)",
        "CREATE INDEX IF NOT EXISTS idx_imei_records_customer_id ON imei_records(customer_id)",
        "CREATE INDEX IF NOT EXISTS idx_imei_records_sale_id ON imei_records(sale_id)",
        "CREATE INDEX IF NOT EXISTS idx_imei_records_invoice_id ON imei_records(invoice_id)",
        "CREATE INDEX IF NOT EXISTS idx_imei_records_return_id ON imei_records(return_id)",
        "CREATE INDEX IF NOT EXISTS idx_imei_records_repair_id ON imei_records(repair_id)",
        "CREATE INDEX IF NOT EXISTS idx_imei_records_sale_item_id ON imei_records(sale_item_id)",
    ]),
]
