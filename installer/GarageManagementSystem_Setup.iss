...
#define MyInstallerBaseName "GarageManagementSystem_Setup_v3.2.0"
...
; are relative to the project root, so "dist\GarageManagementSystem.exe" correctly resolves
; to project_root\dist\GarageManagementSystem.exe.
...
#if FileExists("..\dist\GarageManagementSystem.exe")
  #define MyBuildSourceMode "onefile"
#elif DirExists("..\dist\GarageManagementSystem")
...
; ".." resolves to the project root, so "dist\GarageManagementSystem.exe" means
; project_root\dist\GarageManagementSystem.exe.
SourceDir=..\
...
begin
  MsgBox(
    '{#MyAppName} stores your business data in ' + ExpandConstant('{localappdata}\Garage Management System') + #13#10 +
